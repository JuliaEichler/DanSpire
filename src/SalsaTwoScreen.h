...
class SalsaTwoScreen : public ofxScene{
...
public:
    ...
    void getChoreoPosition(int step, char gender, bool displayPrevious, vector< vector<int> > choreo, bool bdisplayIcon);
    ...
    int                     prevPlayerPos;
    int                     intervall1, intervall2;
    
    Choreography            salsaChoreo;
